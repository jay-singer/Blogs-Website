...
const renderPagination = ()=>{
  ...
  if(currentPage === 0 ) {
   ...
   return (
            <MDBPagination center className='mb-0'>
         <MDBPaginationItem>
            <MDBBtn rounded onClick={() => loadBlogData((currentPage -1) * 5, currentPage *5, -1 )}>Prev</MDBBtn>
            </MDBPaginationItem>
       <MDBPaginationItem>
            <MDBPaginationLink>{currentPage + 1}</MDBPaginationLink>
        </MDBPaginationItem>
         <MDBPaginationItem>
            <MDBBtn rounded onClick={() => loadBlogData((currentPage +1) * 5, (currentPage +2)*5, +1 )}>Next</MDBBtn>
        </MDBPaginationItem>
     </MDBPagination>
   )
  } else{
